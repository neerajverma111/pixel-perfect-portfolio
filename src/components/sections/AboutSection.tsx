...
const AboutSection = () => {
  ...
  const stats = [
    { icon: Calendar, label: "Started Coding", value: "2019" },
          ...
          >
            <div className="relative aspect-square max-w-md mx-auto">
              ...
              <div className="relative glass-card rounded-2xl p-8 h-full flex items-center justify-center">
                <div className="w-48 h-48 md:w-64 md:h-64 rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 border-2 border-primary/30 flex items-center justify-center">
                  <User className="w-24 h-24 md:w-32 md:h-32 text-primary/50" />
                </div>
                ...
                >
                  <div className="absolute bottom-8 right-8 w-2 h-2 rounded-full bg-secondary" />
                </motion.div>
              </div>
            </div>
          </motion.div>
