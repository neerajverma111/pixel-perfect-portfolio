...
const skills: Skill[] = [
  ...
  { name: "Vue.js", level: 75, category: "Frontend", color: "primary" },
  // Backend
  { name: "Node.js", level: 88, category: "Backend", color: "secondary" },
  { name: "Python", level: 80, category: "Backend", color: "secondary" },
  { name: "PostgreSQL", level: 82, category: "Backend", color: "secondary" },
  { name: "GraphQL", level: 78, category: "Backend", color: "secondary" },
  { name: "Redis", level: 70, category: "Backend", color: "secondary" },
  // Tools
  { name: "Git", level: 90, category: "Tools", color: "accent" },
  { name: "Docker", level: 75, category: "Tools", color: "accent" },
  { name: "AWS", level: 72, category: "Tools", color: "accent" },
  { name: "Figma", level: 68, category: "Tools", color: "accent" },
];
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          Always learning, always improving • Currently exploring: AI/ML & Rust
        </motion.p>
      </div>
    </section>
  );
